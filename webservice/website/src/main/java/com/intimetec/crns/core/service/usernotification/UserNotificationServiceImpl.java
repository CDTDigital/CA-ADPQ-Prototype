...
public class UserNotificationServiceImpl implements UserNotificationService {
    ...
    @Override
	public Collection<UserNotification> getByNotificationId(
			long notificationId) {
    	LOGGER.debug("Getting user Notifications by notificationId={}",
    			notificationId);
        Collection<UserNotification> userNotification = 
        		userNotificationRepository.
        		getByNotificationIdOrderByNotificationSentTimeDesc(
        				notificationId);
    ...
    public Collection<UserNotification> getByUserId(long userId) {
       ...
       Collection<UserNotification> userNotifications = 
    		   userNotificationRepository.
    		   getByUserIdOrderByNotificationSentTimeDesc(userId);
       return userNotifications;
    }
    
    @Override
    public Collection<UserNotification> getByUserAuthToken(String authToken) 
    		throws InvalidAuthTokenException {
    	LOGGER.debug("Getting user Notifications  by user authToken={}",
    			authToken);
	...
	@Override
	public Collection<UserNotification> getUserNotificationsByUserId(
	...
	@Override
	public Collection<UserNotification> getUserNotificationsByAuthToken(
			String authToken) throws InvalidAuthTokenException, 
	...
	@Override
	public Optional<UserNotification> getByAuthTokenAndNotificationId(
			String authToken, long notificationId)
			throws InvalidAuthTokenException, InvalidUserException {
		Optional<User> user = userService.getValidUserForAuthToken(authToken);
		if (user.isPresent())
			return userNotificationRepository.getByUserIdAndNotificationId(
					user.get().getId(), notificationId);
		else 
