...
public class AuthSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		LOGGER.info("Device Info: " + ((CurrentUser) authentication.getPrincipal()).getDeviceInfo());
	...
	private void writeResponseMessage(HttpServletResponse response, Map<String, Object> responseMessage) throws java.io.IOException{
