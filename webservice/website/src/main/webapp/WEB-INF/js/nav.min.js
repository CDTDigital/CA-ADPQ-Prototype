(function () {
    ...
    !function t(e, n, i) {
            ...
            "document" in window.self && ("classList" in document.createElement("_") && (!document.createElementNS || "classList" in document.createElementNS("http://www.w3.org/2000/svg", "g")) ? !function () {
                ...
                if ("Element" in t) {
                    ...
                    if (a[n] = Error[n], l.item = function (t) {
                            ...
                            do for (t = n[i] + "", e = c(this, t); e !== -1;)this.splice(e, 1), r = !0, e = c(this, t); while (++i < o);
        ...
        2: [function (t, e, n) {
            (function (t) {
                function n(t, e, n) {
                    ...
                    var v, m, y, g, b, L, A = 0, k = !1, T = !1, O = !0;
                ...
                var a = "Expected a function", c = NaN, u = "[object Symbol]", l = /^\s+|\s+$/g, f = /^[-+]0x[0-9a-f]+$/i, d = /^0b[01]+$/i, h = /^0o[0-7]+$/i, p = parseInt, v = "object" == typeof t && t && t.Object === Object && t, m = "object" == typeof self && self && self.Object === Object && self, y = v || m || Function("return this")(), g = Object.prototype, b = g.toString, w = Math.max, E = Math.min, x = function () {
                    return y.Date.now()
                };
                e.exports = n
        ...
        3: [function (t, e, n) {
            ...
            function o(t) {
                ...
                n.forEach(function (t) {
                    ...
                    t.addEventListener("mouseover", i.bind(e, t));
                    t.addEventListener("mouseout", i.bind(e, t));
                });
            ...
            o.prototype.$ = function (t) {
                ...
                var e = t.getAttribute("aria-controls"), n = this.$("#" + e)[0];
                ...
                var t = this, e = this.$("ul > li > button, .usa-accordion-button");
        ...
        4: [function (t, e, n) {
            ...
            var r = t("../utils/select"), s = t("../utils/dispatch");
            e.exports = o
        }, {"../utils/dispatch": 21, "../utils/select": 22}],
        5: [function (t, e, n) {
            function i(t) {
            ...
            var o = t("../utils/select"), r = t("../utils/dispatch"), s = function () {
                var t = this.parentNode, e = i(t);
                t.classList.remove("hidden"), e.forEach(function (t) {
                    t.classList.add("hidden")
                })
            }, a = [];
            e.exports = function () {
                var t = o(".usa-footer-big nav ul"), e = o(".usa-footer-big nav .usa-footer-primary-link");
        ...
        6: [function (t, e, n) {
            function i(t) {
                var e = s(".usa-overlay, .usa-nav"), n = s(".usa-nav-close")[0];
            ...
            var s = t("../utils/select"), a = t("../utils/dispatch"), c = "ontouchstart" in document.documentElement ? "touchstart" : "click", u = [];
        ...
        7: [function (t, e, n) {
            ...
            var l, f, d, h, p, v = t("../utils/select"), m = t("../utils/dispatch"), y = "usa-sr-only", g = "ontouchstart" in document.documentElement ? "touchstart" : "click";
        ...
        9: [function (t, e, n) {
            ...
            var r = t("./toggle-field-mask"), s = t("../utils/select"), a = function (t, e, n) {
        ...
        10: [function (t, e, n) {
            ...
            var o = t("../utils/select"), r = t("../utils/dispatch");
            e.exports = function (t) {
                function e() {
                    for (n in u)if (n.startsWith("validate")) {
                ...
                var n, s, a, c, u = i(t), l = o(u.validationelement)[0];
                r(t, "keyup", e)
            }
        }, {"../utils/dispatch": 21, "../utils/select": 22}],
        11: [function (t, e, n) {
            var i = t("../utils/select"), o = t("../utils/when-dom-ready"), r = t("../components/accordion");
            o(function () {
        ...
        }, {"../components/accordion": 3, "../utils/select": 22, "../utils/when-dom-ready": 23}],
        12: [function (t, e, n) {
            var i = t("../utils/when-dom-ready"), o = t("../components/banner");
            i(function () {
                o()
            })
        }, {"../components/banner": 4, "../utils/when-dom-ready": 23}],
        13: [function (t, e, n) {
            var i = t("lodash.debounce"), o = t("../utils/when-dom-ready"), r = t("../utils/dispatch"), s = t("../components/footer");
            o(function () {
                s(), r(window, "resize", i(s, 180))
            })
        }, {"../components/footer": 5, "../utils/dispatch": 21, "../utils/when-dom-ready": 23, "lodash.debounce": 2}],
        14: [function (t, e, n) {
            var i = t("../utils/when-dom-ready"), o = t("../utils/select"), r = t("../components/validator"), s = t("../components/toggle-form-input");
            i(function () {
                var t = o(".usa-show_password")[0], e = o(".usa-show_multipassword")[0], n = o(".js-validate_password")[0];
        ...
        15: [function (t, e, n) {
            var i = t("../utils/when-dom-ready"), o = t("../components/navigation");
            i(o)
        }, {"../components/navigation": 6, "../utils/when-dom-ready": 23}],
        16: [function (t, e, n) {
        ...
        }, {"../polyfills/element-hidden": 19, "classlist-polyfill": 1}],
        17: [function (t, e, n) {
            var i = t("../utils/when-dom-ready"), o = t("../components/search");
            i(o)
        }, {"../components/search": 7, "../utils/when-dom-ready": 23}],
        18: [function (t, e, n) {
            var i = t("../utils/dispatch"), o = t("../utils/select"), r = t("../utils/when-dom-ready");
            r(function () {
                var t = o(".skipnav")[0], e = o("#main-content")[0];
        ...
        }, {"../utils/dispatch": 21, "../utils/select": 22, "../utils/when-dom-ready": 23}],
        19: [function (t, e, n) {
            var i = window.HTMLElement.prototype, o = "hidden";
        ...
        21: [function (t, e, n) {
            e.exports = function (t, e, n, i) {
                var o = e.split(/\s+/), r = function (t, e, n) {
