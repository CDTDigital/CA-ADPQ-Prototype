As an IOS user I should have an option to enable my current location tracking so that I can receive notifications or alerts based on my current location.
